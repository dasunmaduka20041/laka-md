...
SESSION_ID: process.env.SESSION_ID || "LAKA-MD=9t53mBBT#pfb1WwGXjIbRi8_vDDadYAXhrlmQKWjSuk_qL-kmkhI",
...
AUTO_READ_STATUS: process.env.AUTO_READ_STATUS === undefined ? "true" : process.env.AUTO_READ_STATUS,true
...
ALLWAYS_OFFLINE: process.env.AUTO_READ_STATUS === undefined ? "false" : process.env.AUTO_READ_STATUS,true
...
ALWAYS_RECORDING: process.env.ALWAYS_RECORDING === undefined ? "false" : process.env.ALWAYS_RECORDING,true
